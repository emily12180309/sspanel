...
install_docker(){
    ...
    echo "4、玄学问题 你太帅导致的 指导联系TG @anankkee"
    echo "5、需要sspanel主题、定制客户端也可联系我哦"
    echo
}
...
while true
do
echo -e "\033[42;30m 此后端为狐狸汉化 不支持审计设备限速 \033[0m"
echo -e "\033[42;30m 需要带审计、支持限速版后端也可联系我哦 \033[0m"
echo -e "\033[42;30m 代搭建或需更多技术指导请联系 TG: @Anankkee \033[0m"
echo  ""
echo  "请输入数字选择你要进行的操作："
